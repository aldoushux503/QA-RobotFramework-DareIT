...
${SUBMITADDBUTTON}       xpath=//*[@id="__next"]/div[1]/main/div[2]/form/div[3]/button[1]
${EDITPLAYERTITLE}       xpath=//span[text()="Edit player Catt Paw"]
...
Click on the submit button
    Click Element   ${SUBMITADDBUTTON}
Assert last added player
    Wait Until Element Is Visible   ${EDITPLAYERTITLE}
    Title Should Be     Edit player Catt Paw
    Capture Page Screenshot     alert.png
